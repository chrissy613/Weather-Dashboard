...
$("#searchBtn").on("click", function() {
    ...
    //GENERATES NEW BUTTON WITH SEARCH INPUT VALUE
    $("#generatedBtn").remove();
    $("<button class='cityBtn' id='generatedBtn'></button>").appendTo( ".cities" );
    $("#generatedBtn").text(cityName1);
    $("#generatedBtn").val(cityName1)
    ...
    // var genStorage = document.querySelector("#generatedBtn");    
    // localStorage.setItem('genStorage', JSON.stringify(document.querySelector("#generatedBtn")));
})});


// var retrievedObject = localStorage.getItem('genStorage');
// function callGenStorage(){
//     $("#generatedBtn").remove();
//     $("<button class='cityBtn' id='generatedBtn'></button>").appendTo( ".cities" );
//     $("#generatedBtn").text($("#searchInput").val());
//     $("#generatedBtn").val($("#searchInput").val());
...
$(document).on("click", "#generatedBtn", function() {
    //1ST AJAX vars
    var generatedSearch = $("#generatedBtn").val();
    var queryURL1 = "https://api.openweathermap.org/data/2.5/forecast?q="+generatedSearch+"&appid=166a433c57516f51dfab1f7edaed8413";
    $.ajax({
    url: queryURL1,
    method: "GET"
  }).then(function(response) {
